...
from pysbs.sbsarchive.sbsargraph import SBSARInput, SBSAROutput
...
print(graph_first.mPkgUrl)
outputs: List[SBSAROutput] = graph_first.getGraphOutputs()
for output in outputs:
    print(output.mIdentifier)
