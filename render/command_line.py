...
from ..preference import SublenderPreferences
from ..props.material import SublenderMaterialSetting
from ..parser.sbsarlite import SbsarGraphInputData
from .. import consts, parser, render

log = logging.getLogger(__name__)


def generate_render_params(
        preferences: SublenderPreferences,
        target_material_name: str,
        m_sublender: SublenderMaterialSetting,
        input_list: list[SbsarGraphInputData],
        graph_setting,
):
    param_list = [
        "render",
...
def handle_render_engine(
    ...
    engine_value, custom_value = preferences.engine_enum, preferences.custom_engine
...
def handle_input_list(
        graph_setting, input_list: list[SbsarGraphInputData], param_list: typing.List[str]
):
...
def handle_input_output_size(
        graph_setting, input_info: SbsarGraphInputData, param_list: list[str]
):
...
def handle_input_normal(
        input_info: SbsarGraphInputData, graph_setting, param_list: typing.List[str]
):
...
def convert_to_command_value(graph_setting, input_info: SbsarGraphInputData, value):
