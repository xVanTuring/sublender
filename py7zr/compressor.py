...
from .exceptions import UnsupportedCompressionMethodError
from .helpers import Buffer, calculate_crc32, calculate_key
from .properties import (FILTER_ARM, FILTER_ARMTHUMB, FILTER_BZIP2, FILTER_COPY, FILTER_CRYPTO_AES256_SHA256,
...
def get_alternative_decompressor(coder: Dict[str, Any], password=None) -> Union[
    bz2.BZ2Decompressor, lzma.LZMADecompressor, ISevenZipDecompressor]:  # noqa
...
def get_methods_names_string(coders_lists: List[List[dict]]) -> str:
    ...
    methods_namelist = ['LZMA2', 'LZMA', 'BZip2', 'DEFLATE', 'DEFLATE64*', 'delta', 'COPY', 'ZStandard', 'LZ4*',
                        'BCJ2*',
